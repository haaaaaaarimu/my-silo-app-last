...
def make_block(prefix, rect_start, circ_start, df):
    ...
    for row in range(2):
        for col in range(7):
            ...
            # 마우스 오버 정보를 위해 data- 속성만 살짝 추가 (레이아웃 영향 X)
...
if raw_data.strip():
    try:
        ...
        <style>
            ...
            .silo-container {{ position: relative; width: 780px; height: 500px; border: 3px solid #000; background: #fff; display: flex; justify-content: center; align-items: center; flex-shrink: 0; }}
